        ...
        html: `
          <div style="font-family:sans-serif;max-width:600px;margin:0 auto;padding:32px;background:#f5f5f0;">
            ...
            <table style="width:100%;border-collapse:collapse;">
              <tr><td style="padding:12px 0;border-bottom:1px solid #ddd;font-weight:600;color:#333;width:140px;">Nombre</td><td style="padding:12px 0;border-bottom:1px solid #ddd;color:#555;">${name}</td></tr>
              <tr><td style="padding:12px 0;border-bottom:1px solid #ddd;font-weight:600;color:#333;">Email</td><td style="padding:12px 0;border-bottom:1px solid #ddd;color:#555;">${email}</td></tr>
              ${company ? `<tr><td style="padding:12px 0;border-bottom:1px solid #ddd;font-weight:600;color:#333;">Empresa</td><td style="padding:12px 0;border-bottom:1px solid #ddd;color:#555;">${company}</td></tr>` : ''}
              ${phone ? `<tr><td style="padding:12px 0;border-bottom:1px solid #ddd;font-weight:600;color:#333;">Teléfono</td><td style="padding:12px 0;border-bottom:1px solid #ddd;color:#555;">${phone}</td></tr>` : ''}
              <tr><td style="padding:12px 0;border-bottom:1px solid #ddd;font-weight:600;color:#333;">Servicio</td><td style="padding:12px 0;border-bottom:1px solid #ddd;color:#555;">${service}</td></tr>
              ${timeline ? `<tr><td style="padding:12px 0;border-bottom:1px solid #ddd;font-weight:600;color:#333;">Plazo</td><td style="padding:12px 0;border-bottom:1px solid #ddd;color:#555;">${timeline}</td></tr>` : ''}
            </table>
